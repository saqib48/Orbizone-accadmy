...
function AboutSection1() {
  return (
    <div className="flex flex-col sm:flex-row my-14 mx-[5%] justify-center items-center">

      <div className="w-full sm:w-[40%] mx-[7.5%] mb-2 sm:mb-0">
      ...
      <div className="w-full sm:w-[31%] mx-[7.5%]  mb-2 sm:mb-0 shadow-lg rounded-xl bg-[#02C6FE] bg-opacity-50">
        <Image width={300} height={300} className='w-full sm:w-[385px] rounded-t-xl' src="/assits/images/class1.webp" alt="class" />
